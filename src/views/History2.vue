<template>
  <div>
    ...
    <div class="fancy-container">
      ...
      <div class="row fancy" v-for="(tx, key) in transaction_queue" :key="key">
        ...
        <div class="col-md-2" v-if="tx.found"><a :href="'https://joticajulian.github.io/hiveexplorer/#/explorer/b/'+tx.block+'/'+tx.transaction">Link</a></div>
